...
int main()
{
	...
	{
		xGzipFile writer = xGzipFile::openForAppend(filename);
		if(writer.valid())
		{
	...
	xGzipFile reader = xGzipFile::openForRead(filename);
	...
	{
		xGzipFile writer = xGzipFile::openForWriteExclusive(filename);
