...
// Create a new LRUCache with a fixed size capacity.  This implementation
// of LRUCache uses a least-recently-used eviction policy.
std::shared_ptr<LRUCache> newLRUCache(size_t capacity);
...
public:
	...
	void prune();
	size_t totalCharge() const { return usage; }
